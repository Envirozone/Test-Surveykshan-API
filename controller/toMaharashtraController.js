...
const fetchData = (data, industry_name, deviceName) => {
...
exports.sendDataToMaharashtra = async (req, res) => {
              ...
              if (currTime - 1000 * 60 * 5 < time) {
                ...
                for (let k = 0; k < value.length; k++) {
                  ...
                  if (
                    ...
                    dataArr.push(
                      `${site_id},${site_uid},${monitoring_id},${analyzer_id},${parameter_pb_id},${element.element.parameter_name
                        .split('+')[0]
                        .replaceAll('_dot_', '.')
                        .toLowerCase()},${
