...
const setDataTOBPCB = async function (
  industry_pb_id,
  station_pb_id,
  data,
  industry_name,
  ...
  try {
    const res = await axios({
      method: "post",
      url: `http://bpcbcems.nic.in/bpcpcb-api/api/industry/${industry_pb_id}/station/${station_pb_id}/data`,
      data,
      headers: {
...
exports.sendDataToBihar = async (req, res) => {
